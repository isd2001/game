...
<%
	...
	try {
		...
		String sql = "insert into baseresult values('"+serial+"','"+user+"', "+ cnt+", "+ elapsed/1000.0 +", to_date('"+ nowString+"','YYYY-MM-DD HH24:MI'))";
	...
	<%
		...
		if(rs.next()) {
			...
			do {
				...
				if(s1.equals(serial)){
					%>
				<font color="#B40404">RANk# <%=rank %>. <%=p1 %>
				<small>시도횟수 : <%=n1 %> / <%=e1 %> sec / <%=d1 %></small></font><br/>
